...
@Autonomous(name="Red Foundation Wall",group="Red Auton")
public class Red1AutonSkyStoneTurnPlatformWall extends RedAutonSkyStone {
    public void addFinalCommands() {
        ...
        group1.addCommand(new DriveSidewaysSkyStoneMecanumNoSkystones(13,DriveSidewaysSkyStoneMecanumNoSkystones.XGREATERTHAN,.65,90, 5000));
        commands.add(group1);
