...
public class DriveForwardHeavySkyStonewithSlideRight extends BasicCommand {
    ...
    boolean coast = false;
    public DriveForwardHeavySkyStonewithSlideRight(double targetPosition, int test, double spd, double targetHeading, long timeOut){
    ...
    public DriveForwardHeavySkyStonewithSlideRight(double targetPosition, int test, double spd, double targetHeading, long timeOut, boolean coast){
        this(targetPosition,test,spd,targetHeading, timeOut);
        this.coast=coast;
    }

    public DriveForwardHeavySkyStonewithSlideRight(double dist) {
