...
@Autonomous(name="Blue Foundation Skybridge",group="Blue Auton")
public class Blue1AutonSkyStoneTurnPlatform extends BlueAutonSkyStone {
    public void addFinalCommands() {
        ...
        group1.addCommand(new DriveSidewaysSkyStoneMecanumNoSkystones(6,DriveSidewaysSkyStoneMecanumNoSkystones.XGREATERTHAN,.65,-90, 5000));
        commands.add(group1);
