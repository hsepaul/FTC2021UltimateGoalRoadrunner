...
public class Red1AutonSkyStone extends RedAutonSkyStone {
    public void addFinalCommands() {
        commands.add(new DriveSidewaysSkyStoneMecanum(12,DriveSidewaysSkyStoneMecanum.XGREATERTHAN,.85,0, 12000));
        ...
        commands.add(new DriveForwardHeavySkyStonewithSlideRight(-30, DriveForwardHeavySkyStonewithSlideRight.XLESSTHAN,-.75,0, 5000));
        commands.add(new WaitForTime(500));
        commands.add(new HooksUp(3000));
        commands.add(new WaitForTime(1500));
        commands.add(new ResetDriveEncoders());
        commands.add(new WaitForTime(250));
        commands.add(new DriveSidewaysSkyStoneMecanum(-50,DriveSidewaysSkyStoneMecanum.XLESSTHAN,-.85,0, 12000));
