...
@Autonomous(name="Blue Foundation Wall",group="Blue Auton")
public class Blue1AutonSkyStoneTurnPlatformWall extends BlueAutonSkyStone {
    public void addFinalCommands() {
        ...
        commands.add(new DriveSidewaysSkyStoneMecanumNoSkystones(-13,DriveSidewaysSkyStoneMecanumNoSkystones.XLESSTHAN,-.85,0, 5000));
        commands.add(new WaitForTime(250));
        commands.add(new ResetDriveEncoders());
        ...
        group.addCommand(new DriveForwardSkyStone(10,DriveForwardSkyStone.XGREATERTHAN,.5,-90, 2000));
        ...
        group1.addCommand(new DriveSidewaysSkyStoneMecanumNoSkystones(-13,DriveSidewaysSkyStoneMecanumNoSkystones.XLESSTHAN,-.65,-90, 5000));
        commands.add(group1);
