...
@Autonomous(name="Red Skystone Skybridge",group="Red Auton")
public class Red2AutonSkyStoneOpenCV extends RedAutonSkyStone {
    public void addFinalCommands() {
        ...
        commands.add(new DriveForwardSkyStoneOpenCV((io.distanceToTape+io.distancePastTape),DriveForwardSkyStone.XGREATERTHAN,.65,90, 8000));
        ...
        commands.add(new DriveForwardHeadingandDistanceSensorSkyStone(io.approachDistance+1.5, DriveForwardHeadingandDistanceSensorSkyStone.LEFTLESSTHAN,.4,0, 1000));
        ...
        commands.add(new DriveForwardSkyStoneOpenCV((io.distanceBetweenSkystones+io.distanceToTape+io.distancePastTape-2),DriveForwardSkyStone.XGREATERTHAN,.85,90, 7000));
